    ...
    <div class="container cont">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-xl-10 col-lg-10 col-md-10 col-sm-10 col-xs-15 mb-10">
                <div class="card">
                    <div class="card-header text-center">PGCET </div>
                     <!-- The slideshow -->
                        <div class="carousel-inner">
                     <div class="carousel-item active">
                     <ul class="navbar-nav ml-auto">
                     <div class="card-body">
                     Karnataka PGCET 2024: Karnataka Examination Authority (KEA) conducts the Karnataka PGCET exam every year. Commencing 2024 session, KEA will likely conduct Karnataka PGCET in an online mode. Details of the PGCET CBT exam will be mentioned in the official notification to be out soon. Candidates can expect the Karnataka PGCET 2024 exam to be conducted in the month of May.
                    </div>
                    <div class="card-body">
                    </div>
                    <div class="card-body">
                    Karnataka PGCET 2024 notification will be out soon. KEA will conduct the Karnataka PGCET 2024 exam for PG professional courses, including MBA, MCA, and MTech. Candidates with a bachelor's degree can apply for Karnataka PGCET 2024 online on the official website, kea.kar.nic.in..<br>
...
function downloadFile() {
    ...
    const fileUrl = "files/PGCET.pdf";
    const fileName = 'PGCET.pdf'; // Specify the file name
