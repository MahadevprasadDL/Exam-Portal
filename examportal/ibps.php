...
<style>
    body {
        background-image: url('image/exam.jpeg');
    ...
    <div class="container cont">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-xl-10 col-lg-10 col-md-10 col-sm-10 col-xs-15 mb-10">
                <div class="card">
                    <div class="card-header text-center">IBPS PO</div>
                     <!-- The slideshow -->
...
The IBPS PO (Institute of Banking Personnel Selection Probationary Officer) exam is conducted by the Institute of Banking Personnel Selection (IBPS) to recruit Probationary Officers in various public sector banks in India. This is a highly sought-after position and the recruitment process is competitive. Here is an overview of the IBPS PO exam

                    </div>
                    <div class="card-body">
                    The IBPS PO exam is a gateway to a promising career in the banking sector. It offers attractive salary, job stability, and opportunities for career advancement. Candidates aspiring to become Probationary Officers should stay updated with the official IBPS notifications, prepare thoroughly for the exams, and enhance their skills to succeed in this competitive recruitment process.
                 <br>

                    <div class="card-body">
                        If You want more information  <a href="https://www.shiksha.com/exams/ibps-po-exam-recruitment" target="_blank"> click here<a>
                    </div>
                    <!-- Add Download Button -->
    ...
    function downloadFile() {
        ...
        const fileUrl = "files/IBPS_PO.pdf";
        const fileName = 'IBPS_PO.pdf'; // Specify the file name
