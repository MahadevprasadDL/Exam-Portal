    ...
    <div class="container cont">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-xl-10 col-lg-10 col-md-10 col-sm-10 col-xs-15 mb-10">
                <div class="card">
                    <div class="card-header text-center">CLAT</div>
                     <!-- The slideshow -->
                        <div class="carousel-inner">
                     <div class="carousel-item active">
                     <ul class="navbar-nav ml-auto">
                     <div class="card-body">
                     The Common Law Admission Test (CLAT) is a centralized national-level entrance exam for admission to 25 of the 27 National Law Universities (NLU), except NLU Delhi and NLU Meghalaya. The All India Law Entrance Test (AILET) is used by NLU Delhi to determine admissions. NLU Meghalaya, on the other hand, also conducts its entrance exam.
                    </div>
                    <div class="card-body">
                    The Common Law Admission Test (CLAT) is a centralized national-level entrance test for admissions to the 25 out of 27 National Law Universities (NLU) except NLU Delhi and NLU Meghalaya[1] which administer their own entrance exams, the All India Law Entrance Test (AILET) and the NLU Meg Admission Test (MEG UAT), respectively. Both AILET & MEG UAT are anticipated to be merged into CLAT in the coming years.[2] CLAT was first introduced in 2008 as a centralized entrance examination for admission to the National Law Schools/Universities in India
                    </div>
                    <div class="card-body">
                    A few private and self-financed law schools in India also use these scores for law admissions. Public sector undertakings in India like ONGC, Coal India, BHEL, the Steel Authority of India, Oil India, the Indian Army (for the recruitment of JAG officers) use CLAT Post Graduation (CLAT PG) scores.
                   .<br>
...
function downloadFile() {
    ...
    const fileUrl = "files/clat.pdf";
    const fileName = 'clat.pdf'; // Specify the file name
