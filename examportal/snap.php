    ...
    <div class="container cont">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-xl-10 col-lg-10 col-md-10 col-sm-10 col-xs-15 mb-10">
                <div class="card">
                    <div class="card-header text-center">SNAP</div>
                     <!-- The slideshow -->
                    ...
                    <div class="card-body">
                    If shortlisted for a programme applied to, the candidate would then need to participate in the further admission process (GE-PI) of that particular programme.

The registration process (including the payment of the registration fee) for SNAP and Institutes is integrated. A candidate can complete the SNAP as well as programme registration and payment on the same portal (snaptest.org).
                    </div>
                    <div class="card-body">
                   .<br>
                    <ul>
                        <li>General English</li>
                        <li>Quantitative, Data Interpretation & Data Sufficiency</li>
...
function downloadFile() {
    ...
    const fileUrl = "files/SNAP.pdf";
    const fileName = 'SNAP.pdf'; // Specify the file name
