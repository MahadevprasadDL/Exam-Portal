...
# Check if user is already logged in, If yes then redirect him to main page
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  if (empty(trim($_POST["user_login"]))) {
    $user_login_err = "Please enter your username or email id.";
  } else {
...
<head>
  ...
  <style>
    body {
      background: url('image/my.jpg') no-repeat center center fixed;
