    ...
    <div class="container cont">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-xl-10 col-lg-10 col-md-10 col-sm-10 col-xs-15 mb-10">
                <div class="card">
                    <div class="card-header text-center"> Indian Administrative Service (IAS)</div>
                     <!-- The slideshow -->
                        <div class="carousel-inner">
                     <div class="carousel-item active">
                     <ul class="navbar-nav ml-auto">
                     <div class="card-body">
                     The Indian Administrative Service (IAS) is the administrative arm of the All India Services of Government of India.[3] The IAS is one of the three All India Services along with the Indian Police Service and Indian Forest Service
                    </div>
                    <div class="card-body">
                    Members of these three services serve the Government of India as well as the individual states. IAS officers are also deployed to various government establishments such as constitutional bodies, staff and line agencies, auxiliary bodies, public sector undertakings, regulatory bodies, statutory bodies and autonomous bodies.
                    </div>
                    <div class="card-body">
                    As with other countries following the parliamentary system of government, the IAS is a part of the permanent bureaucracy of the nation;[4] and is an inseparable part of the executive of the Government of India. As such, the bureaucracy remains politically neutral and guarantees administrative continuity to the ruling party or coalition.<br>
...
function downloadFile() {
    ...
    const fileUrl = "files/IAS.pdf";
    const fileName = 'IAS.pdf'; // Specify the file name
