    ...
    <div class="container cont">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-xl-10 col-lg-10 col-md-10 col-sm-10 col-xs-15 mb-10">
                <div class="card">
                    <div class="card-header text-center">SBI CLERK</div>
                     <!-- The slideshow -->
...
The SBI Clerk (Junior Associate) position is a popular entry-level job opportunity within the State Bank of India (SBI), one of the largest public sector banks in India. SBI conducts regular recruitment drives to hire candidates for the Clerk position across its various branches. Below are key details about the SBI Clerk role
                    </div>
                    <div class="card-body">
                    The SBI Clerk position is a coveted job opportunity for aspirants seeking a career in the banking sector. It offers job stability, career growth, and the opportunity to serve in one of India's premier financial institutions. Candidates should regularly check the official SBI website for recruitment notifications and prepare diligently for the competitive examinations to secure a position as an SBI Clerk.
                 <br>

                    <div class="card-body">
                        If You want more information  <a href="https://www.shiksha.com/exams/sbi-clerk-exam" target="_blank"> click here<a>
                    </div>
                        <!-- Add Download Button -->
...
<script>
    ...
    function downloadFile() {
        ...
        const fileUrl = "files/sbi-clerk.pdf";
        const fileName = 'sbi-clerk.pdf'; // Specify the file name
