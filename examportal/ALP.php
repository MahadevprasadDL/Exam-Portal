    ...
    <div class="container cont">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-xl-10 col-lg-10 col-md-10 col-sm-10 col-xs-15 mb-10">
                <div class="card">
                    <div class="card-header text-center">RRB ALP</div>
                     <!-- The slideshow -->
                        <div class="carousel-inner">
                     <div class="carousel-item active">
                     <ul class="navbar-nav ml-auto">
                     <div class="card-body">
                     The Railway Recruitment Board administers the exam for positions such as Assistant Loco Pilot. A driver is essential to the efficient operation of the railway system and bears the enormous burden of transporting passengers in a safe manner. Those who would like to drive a train may apply for this position. One of the greatest positions in the Indian Railways is that of assistant locomotive pilot.
                    </div>
                    <div class="card-body">
                    The minimum age required to sit for this railway exam is eighteen, while the maximum age is twenty-eight. Candidates must possess a Matriculation/SSLC or have finished Act Apprenticeship studies. Applicants with a three-year diploma or an engineering degree in mechanical, electrical, electronics, or automotive engineering are also qualified
                    </div>
                    <div class="card-body">
                    The RRB ALP (Railway Recruitment Board Assistant Loco Pilot) exam is conducted by the Railway Recruitment Board (RRB) to recruit Assistant Loco Pilots and Technicians in the Indian Railways. This exam is conducted to fill technical positions in the railway sector. Here's an overview of the RRB ALP exam.<br>
...
function downloadFile() {
    ...
    const fileUrl = "files/RRB_ALP.pdf";
