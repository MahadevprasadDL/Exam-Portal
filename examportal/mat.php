    ...
    <div class="container cont">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-xl-10 col-lg-10 col-md-10 col-sm-10 col-xs-15 mb-10">
                <div class="card">
                    <div class="card-header text-center">MAT</div>
                     <!-- The slideshow -->
                    ...
                    <div class="card-body">
                    The exam is held in Computer Based Test (CBT), Paper Based Test (PBT) mode and Internet Based Test (IBT) mode. Held for 150 minutes, MAT exam has 200 questions. The aspirant is tested on the following subjects:
                    </div>
                    <div class="card-body">
                   .<br>
                    <ul>
                        <li>Indian and Global Environment</li>
                        <li>Language Comprehension</li>
                        <li>Data Analysis and Sufficiency</li>
                        <li>Mathematical Skills</li>
                        <li>Intelligence and Critical Reasoning</li>
                    </ul>
...
function downloadFile() {
    ...
    const fileUrl = "files/MAT.pdf";
    const fileName = 'MAT.pdf'; // Specify the file name
